...
function searchByTopic(){
	document.afficheListForm.action="${pageContext.request.contextPath}/searchByTopicUAction";
...
&nbsp;
        <input type="button" name="Submit" value="搜索" onClick="searchByTopic()">
                      ...
                      <tr bgcolor="#FFFFFF" align="center">
                       ...
                       <td align="center"><a href="${pageContext.request.contextPath}/modifyAfficheAction?a_id=${data.a_id}"><img src="${pageContext.request.contextPath}/affiche/images/update.gif" width="22" height="22" border="0"></a></td>
                      </tr>
		              </c:forEach>
